...
/**
 Criar um algoritimo onde digita-se:
 -Nome do aluno
 -Disciplina;
 -Nota1,nota2 e nota3;
 -Frequência do aluno;
 O programa deverá retornar o nome,a disciplina,a média final(n1+n2+n3/3) e se o aluno aprovado(aprovado
 com frequência igual e superior a 75% e média >=6).
 */
